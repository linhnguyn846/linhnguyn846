...
public class SeleniumWebDriverDemo {
  ...
  public static final String PNL_SECTIONS = "//div[@class='category-cards']//div[1]//div[1]//div[2]//input[name()='svg']";

  public static final String LNK_SECTIONS = "baby";
  ...
  public static final String TXT_FIRST_NAME = "//input[@id='firstName']";
...
//    driver.close();
    ...
    Thread.sleep(1000);
    webUI.findElement(By.xpath(PNL_SECTIONS));
    Thread.sleep(1000);
    List<WebElement> elements = webUI.findElements(By.tagName(LNK_SECTIONS));
    for(int i = 0; i < elements.size(); i++){
      System.out.println(elements.get(i).getText());
    }
    Thread.sleep(2000);
    webUI.clickElement(By.xpath(LBL_FORMS));
    Thread.sleep(2000);
    webUI.clickElement(By.xpath(LBL_PRACTICE_FORM));
    Thread.sleep(2000);
    webUI.setText(By.xpath(TXT_FIRST_NAME), "Nhat Thai");
    Thread.sleep(2000);
    webUI.sendKeys(By.xpath(TXT_FIRST_NAME), Keys.chord(Keys.SHIFT, Keys.HOME, Keys.BACK_SPACE));
    Thread.sleep(2000);
