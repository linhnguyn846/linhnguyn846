...
import vn.edu.vtiacademy.training.tests.LoginTest;
...
//    }
    ...
    public void beforeTest(String browser) throws InterruptedException {
        ...
        objManager = objLogin.loginGuru99BankWith("mngr519780", "uquhAqy");
...
//    logger.info("Data file: " + dataFile);
    ...
    public Map<String,Map<String,String>> findTestDataInExcel() {
        String dataFile = this.getDataExcelFile();
        String sheetName = this.getSheetName();
        logger.info("Data file: " + dataFile);
        try {
            return ReadFileExcel.readDataFileExcel(dataFile, sheetName);
        } catch (Exception e) {
