...
public class BaseTest {
    ...
    private static String DEMO_URL = "https://demoqa.com/date-picker";
...
//    }
    ...
    public void beforeClass() {
        logger.info("=====================Before Class: " + DatePickerTest.class.getName());
    }

    @Parameters({"browser"})
    @BeforeTest(alwaysRun = true)
    public void beforeTest(String browser) {
        webUI.openBrowser(browser, DEMO_URL);
    ...
    public void afterClass() {
        logger.info("=====================After Class: " + DatePickerTest.class.getName());
    }
